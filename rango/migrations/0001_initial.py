...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table(u'rango_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rango.Category'])),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128)),
            ('RSVP', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('start_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'rango', ['Event'])
    ...
    models = {
        ...
        u'rango.event': {
            ...
            'RSVP': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
